...
void calculate_face_projection_infos(
    mve::TriangleMesh::ConstPtr mesh, std::vector<TextureView>* texture_views,
    Settings const& settings, FaceProjectionInfos* face_projection_infos) {
...
void calculate_data_costs(mve::TriangleMesh::ConstPtr mesh,
  ...
  calculate_face_projection_infos(mesh, texture_views, settings,
