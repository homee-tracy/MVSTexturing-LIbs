...
inline FrameTimer::FrameTimer(void) {
  this->cur_time = now();
...
inline void FrameTimer::set_max_fps(std::size_t fps) {
  this->max_fps = fps;
}

inline std::size_t FrameTimer::get_max_fps(void) const {
  return this->max_fps;
}

inline std::size_t FrameTimer::get_time(void) const {
  return this->cur_time;
}

inline float FrameTimer::get_time_sec(void) const {
  return (1.0f / 1000.0f) * (float)this->cur_time;
}

inline std::size_t FrameTimer::get_frame_count(void) const {
  return this->frame_count;
}

inline void FrameTimer::next_frame(void) {
  this->last_time = this->cur_time;
...
inline std::size_t FrameTimer::now(void) const {
  return this->timer.get_elapsed();
}

inline std::size_t FrameTimer::delay(std::size_t ms) const {
