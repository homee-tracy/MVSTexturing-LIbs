...
std::string punctated(std::string const& input, char delim = ',',
...
template <typename T>
inline std::string get(T const& value) {
  std::stringstream ss;
  ss << value;
  return ss.str();
}
...
template <>
inline std::string get(std::string const& value) {
  return value;
}

template <typename T>
inline std::string get_fixed(T const& value, int digits) {
  std::stringstream ss;
...
template <typename T>
inline std::string get_digits(T const& value, int digits) {
  std::stringstream ss;
...
template <typename T>
inline std::string get_filled(T const& value, int width, char fill) {
  std::stringstream ss;
...
template <typename T>
inline T convert(std::string const& str, bool strict_conversion) {
...
template <typename T>
inline char const* for_type(void) {
  return "unknown";
}

template <>
inline char const* for_type<int8_t>(void) {
  return "sint8";
}
 ...
 */
template <>
inline char const* for_type<char>(void) {
  return "sint8";
}
#endif

template <>
inline char const* for_type<int16_t>(void) {
  return "sint16";
}

template <>
inline char const* for_type<int32_t>(void) {
  return "sint32";
}

template <>
inline char const* for_type<int64_t>(void) {
  return "sint64";
}

template <>
inline char const* for_type<uint8_t>(void) {
  return "uint8";
}

template <>
inline char const* for_type<uint16_t>(void) {
  return "uint16";
}

template <>
inline char const* for_type<uint32_t>(void) {
  return "uint32";
}

template <>
inline char const* for_type<uint64_t>(void) {
  return "uint64";
}

template <>
inline char const* for_type<float>(void) {
  return "float";
}

template <>
inline char const* for_type<double>(void) {
  return "double";
}

inline int size_for_type_string(std::string const& typestring) {
...
inline void punctate(std::string* str, char delim, std::size_t spacing) {
...
inline std::string punctated(std::string const& input, char delim,
                             std::size_t spacing) {
...
inline void clip_whitespaces(std::string* str) {
...
inline std::string clipped_whitespaces(std::string const& str) {
  std::string ret(str);
  clip_whitespaces(&ret);
  return ret;
}

inline void clip_newlines(std::string* str) {
  while (!str->empty() && (*str->rbegin() == '\r' || *str->rbegin() == '\n'))
    str->resize(str->size() - 1);
}

inline std::string clipped_newlines(std::string const& str) {
  std::string ret(str);
  clip_newlines(&ret);
  return ret;
}

inline std::string wordwrap(char const* str, int width) {
  if (str == nullptr)
    return std::string();
  if (width <= 0)
    return str;
...
inline std::string ellipsize(std::string const& str, std::size_t chars,
                             int type) {
  if (str.size() <= chars)
    return str;
...
inline std::string normalized(std::string const& str) {
  std::string ret(str);
  normalize(&ret);
  return ret;
}
...
inline std::string lowercase(std::string const& str) {
  std::string ret(str);
...
inline std::string get_size_string(std::size_t size) {
  std::string size_str;
  double size_flt;
