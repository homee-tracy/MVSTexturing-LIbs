...
inline ImageBase::ImageBase(void) : w(0), h(0), c(0) {}

inline ImageBase::~ImageBase(void) {}

inline ImageBase::Ptr ImageBase::duplicate_base(void) const {
  return ImageBase::Ptr(new ImageBase(*this));
}

inline int ImageBase::width(void) const {
  return this->w;
}

inline int ImageBase::height(void) const {
  return this->h;
}

inline int ImageBase::channels(void) const {
  return this->c;
}

inline bool ImageBase::valid(void) const {
  return this->w && this->h && this->c;
}

inline bool ImageBase::reinterpret(int new_w, int new_h, int new_c) {
...
inline std::size_t ImageBase::get_byte_size(void) const {
  return 0;
}

inline char const* ImageBase::get_byte_pointer(void) const {
  return nullptr;
}

inline char* ImageBase::get_byte_pointer(void) {
  return nullptr;
}

inline ImageType ImageBase::get_type(void) const {
  return IMAGE_TYPE_UNKNOWN;
}

inline char const* ImageBase::get_type_string(void) const {
  return "unknown";
}

inline ImageType ImageBase::get_type_for_string(
...
template <typename T>
inline TypedImageBase<T>::TypedImageBase(void) {}

template <typename T>
inline TypedImageBase<T>::TypedImageBase(TypedImageBase<T> const& other)
...
template <typename T>
inline ImageBase::Ptr TypedImageBase<T>::duplicate_base(void) const {
  return ImageBase::Ptr(new TypedImageBase<T>(*this));
}

template <typename T>
inline ImageType TypedImageBase<T>::get_type(void) const {
  return IMAGE_TYPE_UNKNOWN;
}

template <>
inline ImageType TypedImageBase<int8_t>::get_type(void) const {
  return IMAGE_TYPE_SINT8;
}

template <>
inline ImageType TypedImageBase<int16_t>::get_type(void) const {
  return IMAGE_TYPE_SINT16;
}

template <>
inline ImageType TypedImageBase<int32_t>::get_type(void) const {
  return IMAGE_TYPE_SINT32;
}

template <>
inline ImageType TypedImageBase<int64_t>::get_type(void) const {
  return IMAGE_TYPE_SINT64;
}

template <>
inline ImageType TypedImageBase<uint8_t>::get_type(void) const {
  return IMAGE_TYPE_UINT8;
}

template <>
inline ImageType TypedImageBase<uint16_t>::get_type(void) const {
  return IMAGE_TYPE_UINT16;
}

template <>
inline ImageType TypedImageBase<uint32_t>::get_type(void) const {
  return IMAGE_TYPE_UINT32;
}

template <>
inline ImageType TypedImageBase<uint64_t>::get_type(void) const {
  return IMAGE_TYPE_UINT64;
}

template <>
inline ImageType TypedImageBase<float>::get_type(void) const {
  return IMAGE_TYPE_FLOAT;
}

template <>
inline ImageType TypedImageBase<double>::get_type(void) const {
  return IMAGE_TYPE_DOUBLE;
}

template <typename T>
inline char const* TypedImageBase<T>::get_type_string(void) const {
  return util::string::for_type<T>();
}

template <typename T>
inline void TypedImageBase<T>::allocate(int width, int height, int chans) {
  this->clear();
  this->resize(width, height, chans);
}

template <typename T>
inline void TypedImageBase<T>::resize(int width, int height, int chans) {
  this->w = width;
  this->h = height;
  this->c = chans;
...
template <typename T>
inline void TypedImageBase<T>::clear(void) {
  this->w = 0;
  this->h = 0;
  this->c = 0;
  this->data.clear();
...
template <typename T>
inline void TypedImageBase<T>::fill(T const& value) {
  std::fill(this->data.begin(), this->data.end(), value);
}

template <typename T>
inline void TypedImageBase<T>::swap(TypedImageBase<T>& other) {
...
template <typename T>
inline typename TypedImageBase<T>::ImageData& TypedImageBase<T>::get_data(
    void) {
  return this->data;
}

template <typename T>
inline typename TypedImageBase<T>::ImageData const& TypedImageBase<T>::get_data(
    void) const {
  return this->data;
}

template <typename T>
inline T const* TypedImageBase<T>::get_data_pointer(void) const {
  if (this->data.empty())
    return nullptr;
  return &this->data[0];
}
...
template <typename T>
inline T* TypedImageBase<T>::get_data_pointer(void) {
  if (this->data.empty())
    return nullptr;
  return &this->data[0];
}
...
template <typename T>
inline T* TypedImageBase<T>::begin(void) {
  return this->data.empty() ? nullptr : &this->data[0];
}

template <typename T>
inline T const* TypedImageBase<T>::begin(void) const {
  return this->data.empty() ? nullptr : &this->data[0];
}

template <typename T>
inline T* TypedImageBase<T>::end(void) {
  return this->data.empty() ? nullptr : this->begin() + this->data.size();
}

template <typename T>
inline T const* TypedImageBase<T>::end(void) const {
  return this->data.empty() ? nullptr : this->begin() + this->data.size();
}

template <typename T>
inline int TypedImageBase<T>::get_pixel_amount(void) const {
  return this->w * this->h;
}

template <typename T>
inline int TypedImageBase<T>::get_value_amount(void) const {
  return static_cast<int>(this->data.size());
}

template <typename T>
inline std::size_t TypedImageBase<T>::get_byte_size(void) const {
  return this->data.size() * sizeof(T);
}

template <typename T>
inline char const* TypedImageBase<T>::get_byte_pointer(void) const {
  return reinterpret_cast<char const*>(this->get_data_pointer());
}

template <typename T>
inline char* TypedImageBase<T>::get_byte_pointer(void) {
...
template <class T>
inline void swap(mve::TypedImageBase<T>& a, mve::TypedImageBase<T>& b) {
  a.swap(b);
}
