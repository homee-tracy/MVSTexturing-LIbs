...
bool Bundle::Feature3D::contains_view_id(int id) const {
...
std::size_t Bundle::get_byte_size(void) const {
  std::size_t ret = 0;
...
std::size_t Bundle::get_num_cameras(void) const {
  return this->cameras.size();
}

/* -------------------------------------------------------------- */

std::size_t Bundle::get_num_valid_cameras(void) const {
  std::size_t ret = 0;
...
TriangleMesh::Ptr Bundle::get_features_as_mesh(void) const {
...
void Bundle::delete_camera(std::size_t index) {
