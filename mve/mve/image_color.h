...
template <>
inline void color_srgb_to_xyz<uint8_t>(uint8_t* v) {
  double out[3];
...
template <>
inline void color_xyz_to_srgb<uint8_t>(uint8_t* v) {
  double out[3];
...
template <>
inline void color_xyy_to_xyz<uint8_t>(uint8_t* v) {
  if (v[1] == 0) {
    v[0] = 0;
    v[1] = 0;
    v[2] = 0;
...
template <>
inline void color_xyz_to_xyy<uint8_t>(uint8_t* v) {
...
template <>
inline void color_rgb_to_ycbcr<uint8_t>(uint8_t* v) {
  double out[3];
...
template <>
inline void color_ycbcr_to_rgb<uint8_t>(uint8_t* v) {
  double out[3];
