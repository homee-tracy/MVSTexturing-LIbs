 ...
 */
FloatImage::Ptr depthmap_bilateral_filter(FloatImage::ConstPtr dm,
                                          math::Matrix3f const& invproj,
                                          float gc_sigma, float pc_fator);
 ...
 */
template <typename T>
void depthmap_convert_conventions(typename Image<T>::Ptr dm,
 ...
 */
TriangleMesh::Ptr depthmap_triangulate(
    FloatImage::ConstPtr dm, math::Matrix3f const& invproj,
...
template <typename T>
inline void depthmap_convert_conventions(typename Image<T>::Ptr dm,
                                         math::Matrix3f const& invproj,
                                         bool to_mve) {
