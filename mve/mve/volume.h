...
template <typename T>
inline Volume<T>::Volume(void) : w(0), h(0), d(0) {}

template <typename T>
inline typename Volume<T>::Ptr Volume<T>::create(int width, int height,
                                                 int depth) {
...
template <typename T>
inline void Volume<T>::allocate(int width, int height, int depth) {
  this->w = width;
  this->h = height;
  this->d = depth;
...
template <typename T>
inline typename Volume<T>::Voxels& Volume<T>::get_data(void) {
  return this->data;
}

template <typename T>
inline typename Volume<T>::Voxels const& Volume<T>::get_data(void) const {
  return this->data;
}

template <typename T>
inline int Volume<T>::width(void) const {
  return this->w;
}

template <typename T>
inline int Volume<T>::height(void) const {
  return this->h;
}

template <typename T>
inline int Volume<T>::depth(void) const {
  return this->d;
}
