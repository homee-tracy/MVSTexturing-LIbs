...
struct CameraInfo {
 public:
  ...
  /**
     ...
     */
  void fill_reprojection(CameraInfo const& destination, float src_width,
                         float src_height, float dst_width, float dst_height,
  ...
  /**
     ...
     */
  void fill_gl_projection(float* mat, float width, float height, float znear,
                          float zfar) const;
