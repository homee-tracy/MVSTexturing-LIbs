...
inline Bundle::Bundle(void) {}

inline Bundle::Ptr Bundle::create(void) {
  return Ptr(new Bundle);
}

inline Bundle::Cameras const& Bundle::get_cameras(void) const {
  return this->cameras;
}

inline Bundle::Cameras& Bundle::get_cameras(void) {
  return this->cameras;
}

inline Bundle::Features const& Bundle::get_features(void) const {
  return this->features;
}

inline Bundle::Features& Bundle::get_features(void) {
  return this->features;
}
