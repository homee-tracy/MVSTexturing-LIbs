...
inline MeshBase::MeshBase(void) {}

inline MeshBase::~MeshBase(void) {}

inline MeshBase::VertexList const& MeshBase::get_vertices(void) const {
  return this->vertices;
}

inline MeshBase::VertexList& MeshBase::get_vertices(void) {
  return this->vertices;
}

inline MeshBase::ColorList const& MeshBase::get_vertex_colors(void) const {
  return this->vertex_colors;
}

inline MeshBase::ColorList& MeshBase::get_vertex_colors(void) {
  return this->vertex_colors;
}

inline MeshBase::ConfidenceList const& MeshBase::get_vertex_confidences(
    void) const {
  return this->vertex_confidences;
}

inline MeshBase::ConfidenceList& MeshBase::get_vertex_confidences(void) {
  return this->vertex_confidences;
}

inline MeshBase::ValueList const& MeshBase::get_vertex_values(void) const {
  return this->vertex_values;
}

inline MeshBase::ValueList& MeshBase::get_vertex_values(void) {
  return this->vertex_values;
}

inline void MeshBase::clear(void) {
  this->vertices.clear();
...
inline bool MeshBase::has_vertex_colors(void) const {
  return !this->vertices.empty() &&
         this->vertex_colors.size() == this->vertices.size();
}

inline bool MeshBase::has_vertex_confidences(void) const {
  return !this->vertices.empty() &&
         this->vertex_confidences.size() == this->vertices.size();
}

inline bool MeshBase::has_vertex_values(void) const {
  return !this->vertices.empty() &&
...
inline TriangleMesh::Ptr TriangleMesh::duplicate(void) const {
  return Ptr(new TriangleMesh(*this));
}

inline TriangleMesh::TriangleMesh(void) {}

inline TriangleMesh::~TriangleMesh(void) {}

inline TriangleMesh::Ptr TriangleMesh::create(void) {
  return Ptr(new TriangleMesh);
}

inline TriangleMesh::Ptr TriangleMesh::create(TriangleMesh::ConstPtr other) {
  return Ptr(new TriangleMesh(*other));
}

inline TriangleMesh::NormalList const& TriangleMesh::get_vertex_normals(
    void) const {
  return this->vertex_normals;
}

inline TriangleMesh::NormalList& TriangleMesh::get_vertex_normals(void) {
  return this->vertex_normals;
}

inline TriangleMesh::TexCoordList const& TriangleMesh::get_vertex_texcoords(
    void) const {
  return this->vertex_texcoords;
}

inline TriangleMesh::TexCoordList& TriangleMesh::get_vertex_texcoords(void) {
  return this->vertex_texcoords;
}

inline TriangleMesh::FaceList const& TriangleMesh::get_faces(void) const {
  return this->faces;
}

inline TriangleMesh::FaceList& TriangleMesh::get_faces(void) {
  return this->faces;
}

inline TriangleMesh::NormalList const& TriangleMesh::get_face_normals(
    void) const {
  return this->face_normals;
}

inline TriangleMesh::NormalList& TriangleMesh::get_face_normals(void) {
  return this->face_normals;
}

inline TriangleMesh::ColorList& TriangleMesh::get_face_colors(void) {
  return this->face_colors;
}

inline TriangleMesh::ColorList const& TriangleMesh::get_face_colors(
    void) const {
  return this->face_colors;
}

inline void TriangleMesh::clear_normals(void) {
  this->vertex_normals.clear();
  this->face_normals.clear();
}

inline void TriangleMesh::clear(void) {
  this->MeshBase::clear();
  this->vertex_normals.clear();
...
inline bool TriangleMesh::has_vertex_normals(void) const {
  return !this->vertices.empty() &&
         this->vertex_normals.size() == this->vertices.size();
}

inline bool TriangleMesh::has_vertex_texcoords(void) const {
  return !this->vertices.empty() &&
         this->vertex_texcoords.size() == this->vertices.size();
}

inline bool TriangleMesh::has_face_normals(void) const {
  return !this->faces.empty() &&
         this->faces.size() == this->face_normals.size() * 3;
}

inline bool TriangleMesh::has_face_colors(void) const {
  return !this->faces.empty() &&
