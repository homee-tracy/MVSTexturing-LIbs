...
template <typename T, int N>
inline Vector<T, N>::Vector(T const* values) {
  std::copy(values, values + N, v);
}

template <typename T, int N>
inline Vector<T, N>::Vector(T const& value) {
  fill(value);
}

template <typename T, int N>
inline Vector<T, N>::Vector(T const& v1, T const& v2) {
  v[0] = v1;
  v[1] = v2;
}

template <typename T, int N>
inline Vector<T, N>::Vector(T const& v1, T const& v2, T const& v3) {
  v[0] = v1;
  v[1] = v2;
  v[2] = v3;
}
...
template <typename T, int N>
inline Vector<T, N>::Vector(Vector<T, N - 1> const& other, T const& v1) {
  std::copy(*other, *other + N - 1, v);
  v[N - 1] = v1;
}

template <typename T, int N>
inline Vector<T, N>::Vector(Vector<T, N> const& other) {
  std::copy(*other, *other + N, v);
}

template <typename T, int N>
template <typename O>
inline Vector<T, N>::Vector(Vector<O, N> const& other) {
  std::copy(*other, *other + N, v);
}

template <typename T, int N>
template <typename O>
inline Vector<T, N>::Vector(O const* values) {
  std::copy(values, values + N, v);
}
...
template <typename T, int N>
inline Vector<T, N> cross_product(Vector<T, N> const& /*v1*/,
                                  Vector<T, N> const& /*v2*/) {
...
template <typename T>
inline Vector<T, 3> cross_product(Vector<T, 3> const& v1,
                                  Vector<T, 3> const& v2) {
...
template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::fill(T const& value) {
  std::fill(v, v + N, value);
  return *this;
}

template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::copy(T const* values, int num) {
  std::copy(values, values + num, this->v);
  return *this;
}

template <typename T, int N>
inline int Vector<T, N>::dim(void) const {
  return N;
}

template <typename T, int N>
inline T Vector<T, N>::minimum(void) const {
  return *std::min_element(v, v + N);
}

template <typename T, int N>
inline T Vector<T, N>::maximum(void) const {
  return *std::max_element(v, v + N);
}

template <typename T, int N>
inline T Vector<T, N>::sum(void) const {
  return std::accumulate(v, v + N, T(0), std::plus<T>());
}

template <typename T, int N>
inline T Vector<T, N>::abs_sum(void) const {
  return std::accumulate(v, v + N, T(0), &algo::accum_absolute_sum<T>);
}

template <typename T, int N>
inline T Vector<T, N>::product(void) const {
...
template <typename T, int N>
inline T Vector<T, N>::norm(void) const {
  return std::sqrt(square_norm());
}

template <typename T, int N>
inline T Vector<T, N>::square_norm(void) const {
  return std::accumulate(v, v + N, T(0), &algo::accum_squared_sum<T>);
}

template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::normalize(void) {
  std::for_each(v, v + N, algo::foreach_divide_by_const<T>(norm()));
  return *this;
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::normalized(void) const {
  return Vector<T, N>(*this).normalize();
}

template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::abs_value(void) {
  std::for_each(v, v + N, &algo::foreach_absolute_value<T>);
  return *this;
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::abs_valued(void) const {
  return Vector<T, N>(*this).abs_value();
}

template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::negate(void) {
  std::for_each(v, v + N, &algo::foreach_negate_value<T>);
  return *this;
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::negated(void) const {
  return Vector<T, N>(*this).negate();
}

template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::sort_asc(void) {
  std::sort(v, v + N, std::less<T>());
  return *this;
}

template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::sort_desc(void) {
  std::sort(v, v + N, std::greater<T>());
  return *this;
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::sorted_asc(void) const {
  return Vector<T, N>(*this).sort_asc();
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::sorted_desc(void) const {
  return Vector<T, N>(*this).sort_desc();
}

template <typename T, int N>
template <typename F>
inline Vector<T, N>& Vector<T, N>::apply_for_each(F functor) {
...
template <typename T, int N>
template <typename F>
inline Vector<T, N> Vector<T, N>::applied_for_each(F functor) const {
...
template <typename T, int N>
inline T Vector<T, N>::dot(Vector<T, N> const& other) const {
  return std::inner_product(v, v + N, *other, T(0));
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::cross(Vector<T, N> const& other) const {
  return cross_product(*this, other);
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::cw_mult(Vector<T, N> const& other) const {
  Vector<T, N> ret;
...
template <typename T, int N>
inline Vector<T, N> Vector<T, N>::cw_div(Vector<T, N> const& other) const {
  Vector<T, N> ret;
...
template <typename T, int N>
inline bool Vector<T, N>::is_similar(Vector<T, N> const& other,
                                     T const& eps) const {
...
template <typename T, int N>
inline T* Vector<T, N>::begin(void) {
  return v;
}

template <typename T, int N>
inline T const* Vector<T, N>::begin(void) const {
  return v;
}

template <typename T, int N>
inline T* Vector<T, N>::end(void) {
  return v + N;
}

template <typename T, int N>
inline T const* Vector<T, N>::end(void) const {
  return v + N;
}
...
template <typename T, int N>
inline T* Vector<T, N>::operator*(void) {
  return v;
}

template <typename T, int N>
inline T const* Vector<T, N>::operator*(void) const {
  return v;
}
...
template <typename T, int N>
inline T const& Vector<T, N>::operator[](int index) const {
  return v[index];
}
...
template <typename T, int N>
inline bool Vector<T, N>::operator==(Vector<T, N> const& rhs) const {
...
template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::operator=(Vector<T, N> const& rhs) {
...
template <typename T, int N>
template <typename O>
inline Vector<T, N>& Vector<T, N>::operator=(Vector<O, N> const& rhs) {
  std::copy(*rhs, *rhs + N, v);
  return *this;
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::operator-(void) const {
  return negated();
}
...
template <typename T, int N>
inline Vector<T, N> Vector<T, N>::operator-(Vector<T, N> const& rhs) const {
...
template <typename T, int N>
inline Vector<T, N>& Vector<T, N>::operator-=(T const& rhs) {
  std::for_each(v, v + N, algo::foreach_substraction_with_const<T>(rhs));
  return *this;
}

template <typename T, int N>
inline Vector<T, N> Vector<T, N>::operator-(T const& rhs) const {
  return Vector<T, N>(*this) -= rhs;
}
...
template <typename T, int N>
inline Vector<T, N> operator*(T const& s, Vector<T, N> const& v) {
  return v * s;
}
