 ...
 */
template <typename T>
bool triangle_box_overlap(math::Vector<T, 3> const& boxcenter,
 ...
 */
template <typename T>
bool plane_box_overlap(math::Vector<T, 3> const& normal,
 ...
 */
template <typename T>
bool ray_box_overlap(math::Vector<T, 3> const& origin,
 ...
 */
template <typename T>
T ray_triangle_intersect(math::Vector<T, 3> const& origin,
                         math::Vector<T, 3> const& dir,
                         math::Vector<T, 3> const& a,
                         math::Vector<T, 3> const& b,
                         math::Vector<T, 3> const& c, float* bary = 0);
...
bool box_box_overlap(math::Vector<T, N> const& b1min,
 ...
 */
template <typename T>
math::Vector<T, 2> ray_ray_intersect(math::Vector<T, 3> const& p1,
 ...
 */
template <typename T, int N>
bool point_box_overlap(math::Vector<T, N> const& point,
...
T ray_triangle_intersect(math::Vector<T, 3> const& origin,
                         ...
                         math::Vector<T, 3> const& a,
                         math::Vector<T, 3> const& b,
                         math::Vector<T, 3> const& c, float* bary) {
