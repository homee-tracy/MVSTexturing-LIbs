 ...
 */
template <typename T>
math::Vector<T, 3> circumsphere_center(math::Vector<T, 3> const& a,
 ...
 */
template <typename T>
float circumsphere_radius(math::Vector<T, 3> const& a,
                          math::Vector<T, 3> const& b,
                          math::Vector<T, 3> const& c,
                          math::Vector<T, 3> const& d);
 ...
 */
template <typename T>
float circumsphere_test(math::Vector<T, 3> const& a,
                        math::Vector<T, 3> const& b,
                        math::Vector<T, 3> const& c,
                        math::Vector<T, 3> const& d,
 ...
 */
template <typename T>
float insphere_radius(math::Vector<T, 3> const& a, math::Vector<T, 3> const& b,
                      math::Vector<T, 3> const& c, math::Vector<T, 3> const& d);
 ...
 */
template <typename T>
T triangle_area(math::Vector<T, 3> const& a, math::Vector<T, 3> const& b,
                math::Vector<T, 3> const& c);
 ...
 */
template <typename T>
T tetrahedron_volume(math::Vector<T, 3> const& a, math::Vector<T, 3> const& b,
                     math::Vector<T, 3> const& c, math::Vector<T, 3> const& d);
 ...
 */
template <typename T>
T tetrahedron_orientation(math::Vector<T, 3> const& a,
                          math::Vector<T, 3> const& b,
                          math::Vector<T, 3> const& c,
                          math::Vector<T, 3> const& d);
 ...
 */
template <typename T>
math::Vector<T, 3> tetrahedron_bary(math::Vector<T, 3> const& a,
                                    math::Vector<T, 3> const& b,
                                    math::Vector<T, 3> const& c,
                                    math::Vector<T, 3> const& d,
                                    math::Vector<T, 3> const& p);
 ...
 */
template <typename T>
bool points_coplanar(math::Vector<T, 3> const& a, math::Vector<T, 3> const& b,
                     math::Vector<T, 3> const& c, math::Vector<T, 3> const& d,
                     T const& cos_angle);
...
math::Vector<T, 3> circumsphere_center(math::Vector<T, 3> const& a,
  ...
  math::Vector<T, 3> ret =
      x1 * da.square_norm() + x2 * ca.square_norm() + x3 * ba.square_norm();
...
float insphere_radius(math::Vector<T, 3> const& a, math::Vector<T, 3> const& b,
  ...
  return vol6 /
         (vb.cross(vc).norm() + vc.cross(va).norm() + va.cross(vb).norm() +
...
template <typename T>
inline T tetrahedron_volume(math::Vector<T, 3> const& a,
                            math::Vector<T, 3> const& b,
                            math::Vector<T, 3> const& c,
                            math::Vector<T, 3> const& d) {
#if 1
...
template <typename T>
inline T tetrahedron_orientation(math::Vector<T, 3> const& a,
                                 math::Vector<T, 3> const& b,
                                 math::Vector<T, 3> const& c,
                                 math::Vector<T, 3> const& d) {
